...
const apiEndpoints: ApiEndpoint[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { name: 'sku', type: 'string', required: false, description: 'Internal SKU (max 50 chars)' },
      { name: 'categoryId', type: 'number', required: false, description: 'Category ID (required if no categoryName)' },
      { name: 'categoryName', type: 'string', required: false, description: 'Category name (required if no categoryId)' },
      { name: 'brandId', type: 'number', required: false, description: 'Brand ID' },
      { name: 'brandName', type: 'string', required: false, description: 'Brand name' },
      { name: 'price', type: 'number', required: false, description: 'Product price (> 0)' },
      { name: 'unit', type: 'string', required: true, description: 'Unit (VD: Lon, Chai, Kg)' },
      { name: 'weightVolume', type: 'string', required: false, description: 'Weight / volume (VD: 330ml)' },
      { name: 'origin', type: 'string', required: false, description: 'Origin country / location' },
      { name: 'ingredients', type: 'string', required: false, description: 'Ingredients information' },
      { name: 'nutritionalInfo', type: 'string', required: false, description: 'Nutritional information' },
      { name: 'usageInstructions', type: 'string', required: false, description: 'Usage instructions' },
      { name: 'storageInstructions', type: 'string', required: false, description: 'Storage instructions' },
      { name: 'shelfLifeDays', type: 'number', required: false, description: 'Shelf life in days' },
      ...
      { name: 'images', type: 'array', required: false, description: 'Multiple images [{ imageUrl, imagePublicId, isPrimary, order }]' },
      ...
      { name: 'isActive', type: 'boolean', required: false, description: 'Product active status' },
    ],
    response: 'Product',
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { name: 'sku', type: 'string', required: false, description: 'Internal SKU' },
      { name: 'categoryId', type: 'number', required: false, description: 'Category ID' },
      { name: 'categoryName', type: 'string', required: false, description: 'Category name' },
      { name: 'brandId', type: 'number', required: false, description: 'Brand ID' },
      { name: 'brandName', type: 'string', required: false, description: 'Brand name' },
      { name: 'price', type: 'number', required: false, description: 'Product price' },
      { name: 'unit', type: 'string', required: false, description: 'Unit' },
      { name: 'weightVolume', type: 'string', required: false, description: 'Weight / volume' },
      { name: 'origin', type: 'string', required: false, description: 'Origin country / location' },
      { name: 'ingredients', type: 'string', required: false, description: 'Ingredients information' },
      { name: 'nutritionalInfo', type: 'string', required: false, description: 'Nutritional information' },
      { name: 'usageInstructions', type: 'string', required: false, description: 'Usage instructions' },
      ...
      { name: 'images', type: 'array', required: false, description: 'Multiple images (replace current set)' },
      { name: 'imageUrl', type: 'string', required: false, description: 'Image URL' },
      { name: 'imagePublicId', type: 'string', required: false, description: 'Cloudinary public ID' },
      { name: 'isActive', type: 'boolean', required: false, description: 'Product active status' },
    ],
